    ...
    var n, t, o, e, a = [],
        ...
        C = function (r, n) {
            for (var t = [],
                ...
                )t[f] ^= p(n[f], a); return t
        },
        w = function (r) {
            for (var n = [
                function () {
                    return 0 == (t + o) % 2
                }, function () { return 0 == t % 2 }, function () { return 0 == o % 3 }, function () { return 0 == (t + o) % 3 }, function () { return 0 == ((t / 2 | 0) + (o / 3 | 0)) % 2 }, function () { return 0 == t * o % 2 + t * o % 3 }, function () { return 0 == (t * o % 2 + t * o % 3) % 2 }, function () { return 0 == ((t + o) % 2 + t * o % 3) % 2 }][r], t = e; t--;)for (var o = e; o--;)f[t][o] || (a[t][o] ^= n())
        },
        b = function () {
            for (var r = function (r, n) {
                ...
                t = function (r) {
                    var n = r[5], t = n > 0 && r[4] == n && r[3] == 3 * n && r[2] == n && r[1] == n; return (t && r[6] >= 4 * n && r[0] >= n ? 1 : 0) + (t && r[0] >= 4 * n && r[6] >= n ? 1 : 0)
                }, o = 0, f = e * e, i = 0, u = e; u--;) { for (var c = [0, 0, 0, 0, 0, 0, 0], s = [0, 0, 0, 0, 0, 0, 0], l = !1, g = !1, d = 0, m = 0, p = e; p--;) { a[u][p] == l ? 5 == ++d ? o += 3 : d > 5 && o++ : (r(d, c), o += 40 * t(c), d = 1, l = a[u][p]), a[p][u] == g ? 5 == ++m ? o += 3 : m > 5 && o++ : (r(m, s), o += 40 * t(s), m = 1, g = a[p][u]); var C = a[u][p]; C && i++, p && u && C == a[u][p - 1] && C == a[u - 1][p] && C == a[u - 1][p - 1] && (o += 3) } o += 40 * n(l, d, c) + 40 * n(g, m, s) } return o += 10 * (v(h(20 * i - 10 * f) / f) - 1)
        },
        A = function (r, n, t) {
            for (; n--;)t.push(r >>> n & 1)
        },
        ...
        x = function (r, n) {
            for (var t = 0,
                o = r.length;
                o--;) {
                var e = r[o], a = M(e, n); if (1 << a <= e.numChars) return 1 / 0; t += 4 + a + e.bitData.length
            } return t
        },
        D = function (r) {
            if (r < 1 || r > 40)
...
function parseINIString(s) {
    ...
    return n.forEach(function (s) {
        if (!t.comment.test(s)) {
            if (t.param.test(s)) {
                var n = s.match(t.param); a ? e[a][n[1]] = n[2] : e[n[1]] = n[2]
            }
            else if (t.section.test(s)) {
                var n = s.match(t.section);
                e[n[1]] = {}, a = n[1]
            }
            else 0 == s.length && a && (a = null)
        }
    }), e
}
...
function wgtomt() {
    ...
    document.getElementById("mtcmd").innerHTML = "/interface/wireguard/add name=\"" + interfaceName + "\"" +
        ...
        " persistent-keepalive=" + (iniData.Peer.PersistentKeepalive ? (iniData.Peer.PersistentKeepalive + "s") : "25s") +
        " client-keepalive=" + (iniData.Peer.ClientKeepalive ? (iniData.Peer.ClientKeepalive + "s") : "25s") +
    ...
    var qrcodes = [
        ...
        new QRCode({
            msg: document.getElementById("inicfg").value
            , dim: 512
            , pad: 4
            , mtx: -1
            , ecl: "L"
    ...
    for (var c = 0; c < qrcodes.length; c++) {
        document.getElementById("outputQR").appendChild(qrcodes[c]);
    }
}
